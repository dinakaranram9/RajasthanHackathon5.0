...
{
	echo "in";
$query=mysqli_query($conn,"select username,password from administrator where username='$uid' and password='$pwd'");
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<div class="message_top_text text-center">
							<h2>Admin Login</h2>
							<p class="description_p">Enter your User Name and Password</p>
						</div>
					</div>
				</div>
								...
								<form action="" id="formid" method="POST">
										<!--<div class="col-lg-8 col-md-8 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">-->
										   ...
										   <div class="form-group">
											<input type="text" class="form-control" name="uid" placeholder="Type Your User Name" required="">
										  </div>

										  <div class="form-group">
											<input type="password" class="form-control" name="pwd" placeholder="Type your Password" required="">
										  </div>
